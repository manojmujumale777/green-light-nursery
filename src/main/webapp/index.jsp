            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="flex items-center space-x-4 pl-4 border-l border-stone-200">
                        <a href="signin.jsp" class="text-emerald-700 font-semibold hover:text-emerald-900"><%=LOGIN%></a>
                        <a href="signup.jsp" class="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-full font-bold shadow-lg shadow-emerald-100 transition transform hover:-translate-y-0.5"><%=REGISTER%></a>
                    </div>
                    <div class="flex items-center space-x-2">
   ...
   <a href="Language?lang=mr" class="text-sm border px-2 py-1 rounded">मराठी</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-b border-stone-100 px-4 py-6 space-y-4">
            ...
            <div class="pt-4 flex flex-col space-y-3">
                <a href="index.jsp" class="text-center py-3 text-emerald-700 font-bold border border-emerald-600 rounded-xl"><%=LOGIN%></a>
                <a href="signup.jsp" class="text-center py-3 bg-emerald-600 text-white font-bold rounded-xl shadow-lg"><%=REGISTER%></a>
            </div>
        </div>
    </nav>
